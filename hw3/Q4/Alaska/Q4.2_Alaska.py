...
df_2018 = df_2018.loc[(df_2018['sub_region_1'] == 'Alaska')]
...
df_2019 = df_2019.loc[(df_2019['sub_region_1'] == 'Alaska')]
...
plt.xlabel("Epiweeks")
plt.ylabel("Values")
plt.title("Flu Symptom Trends for 2018-2019 Season (Alaska)")
plt.legend()
plt.show()
